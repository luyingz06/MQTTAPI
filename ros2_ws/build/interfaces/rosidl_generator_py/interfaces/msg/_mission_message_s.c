...
bool interfaces__msg__mission_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._mission_message.MissionMessage", full_classname_dest, 46) == 0);
  }
  interfaces__msg__MissionMessage * ros_message = _ros_message;
  {  // mission_id
...
{
  /* NOTE(esteve): Call constructor of MissionMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._mission_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MissionMessage");
